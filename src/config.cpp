...
static void from_json(const nlohmann::json& j, agent_config_data& data)
{
...
agent_config_data agent_config_data::from_toml_file(const std::string& file_path)
{
  toml::table data;
  try
  {
  ...
  return j.get<agent_config_data>();
}

agent_config_data agent_config_data::from_json_file(const std::string& file_path)
{
...
void agent_config_data::load_config_options_to_trackers()
{
