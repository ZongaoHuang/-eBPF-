...
sec_analyzer_prometheus::sec_analyzer_prometheus(prometheus_server &server, const std::vector<sec_rule_describe> &in_rules)
    : sec_analyzer(in_rules),
      agent_sec_warn_counter(prometheus::BuildCounter()
                                   .Name("agent_seccurity_warn_count")
                                   .Help("Number of observed security warnings")
                                   .Register(*server.registry)),
      agent_sec_event_counter(prometheus::BuildCounter()
                                    .Name("agent_seccurity_event_count")
                                    .Help("Number of observed security event")
                                    .Register(*server.registry)),
      agent_sec_alert_counter(prometheus::BuildCounter()
                                    .Name("agent_seccurity_alert_count")
