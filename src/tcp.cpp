...
tcp_tracker::prometheus_event_handler::prometheus_event_handler(prometheus_server &server)
    : agent_tcp_v4_counter(prometheus::BuildCounter()
                                 .Name("agent_observed_tcp_v4_count")
                                 .Help("Number of observed tcp4 connect count")
                                 .Register(*server.registry)),
      agent_tcp_v6_counter(prometheus::BuildCounter()
                                 .Name("agent_observed_tcp_v6_count")
