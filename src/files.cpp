...
files_tracker::prometheus_event_handler::prometheus_event_handler(prometheus_server &server)
    : agent_files_read_counter(prometheus::BuildCounter()
                                     .Name("agent_observed_files_read_count")
                                     .Help("Number of observed files read count")
                                     .Register(*server.registry)),
      agent_files_write_counter(prometheus::BuildCounter()
                                      .Name("agent_observed_files_write_count")
                                      .Help("Number of observed files write count")
                                      .Register(*server.registry)),
      agent_files_write_bytes(prometheus::BuildCounter()
                                    .Name("agent_observed_files_write_bytes")
                                    .Help("Number of observed files write bytes")
                                    .Register(*server.registry)),
      agent_files_read_bytes(prometheus::BuildCounter()
                                   .Name("agent_observed_files_read_bytes")
