...
process_tracker::prometheus_event_handler::prometheus_event_handler(prometheus_server &server)
    : agent_process_start_counter(prometheus::BuildCounter()
                                        .Name("agent_bserved_process_start")
                                        .Help("Number of observed process start")
                                        .Register(*server.registry)),
      agent_process_exit_counter(prometheus::BuildCounter()
                                       .Name("agent_observed_process_end")
