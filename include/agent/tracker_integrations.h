...
#include "agent/model/tracker_alone.h"
...
struct tcpconnlat_tracker final : public tracker_alone_base
{
  ...
  {
    prometheus::Family<prometheus::Histogram> &agent_tcpconnlat_v4_counter;
    prometheus::Family<prometheus::Histogram> &agent_tcpconnlat_v6_counter;
...
struct capable_tracker final : public tracker_alone_base
{
  ...
  struct prometheus_event_handler : public event_handler<tracker_alone_event>
  {
    prometheus::Family<prometheus::Counter> &agent_capable_counter;
    const container_manager &container_manager_ref;
...
struct mountsnoop_tracker final : public tracker_alone_base
{
  ...
  struct prometheus_event_handler : public event_handler<tracker_alone_event>
  {
    prometheus::Family<prometheus::Counter> &agent_mountsnoop_counter;
    const container_manager &container_manager_ref;
...
struct sigsnoop_tracker final : public tracker_alone_base
{
  ...
  struct prometheus_event_handler : public event_handler<tracker_alone_event>
  {
    prometheus::Family<prometheus::Counter> &agent_sigsnoop_counter;
    const container_manager &container_manager_ref;
...
struct opensnoop_tracker final : public tracker_alone_base
{
  ...
  struct prometheus_event_handler : public event_handler<tracker_alone_event>
  {
    prometheus::Family<prometheus::Counter> &agent_opensnoop_counter;
    const container_manager &container_manager_ref;
...
struct bindsnoop_tracker final : public tracker_alone_base
{
  ...
  struct prometheus_event_handler : public event_handler<tracker_alone_event>
  {
    prometheus::Family<prometheus::Counter> &agent_bind_counter;
    const container_manager &container_manager_ref;
